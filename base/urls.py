...
urlpatterns = [
    ...
    path('task/<int:task_id>/editor/formulas/extract', web_page.views.formula_extract_variables, name='task_formula_extract'),
    path('task/<int:task_id>/editor/formulas/create', web_page.views.task_create_formula, name='task_create_formula'),
    path('task/<int:task_id>/editor/formulas/mapping', web_page.views.task_formulas_mapping_by_id, name='task_formulas_mapping'),
    path('task/<int:task_id>/editor/formulas/mapping_by_name', web_page.views.task_formulas_mapping_by_name, name='task_formulas_mapping_by_name'),
    ...
    path('fp/file/pdf/<int:file_id>', web_page.logic.file_uploader.get_pdf, name="get_pdf"),
